...
PERSONAS: dict[str, str] = {
    ...
    "app-studio-ceo": (
        ...
        "Is devrederken: cevapta @agent_adi yaz, o agent tetiklenir. "
        "STORE RELEASE AKIS: 1) exec.read_file ile repo/docs/SCREEN_SPEC.md kontrol, "
        "2) Varsa @dev'e 'build tetikle' talimati ver, 3) Dev Codemagic'i tetikler "
        "4) @qa 'exec.codemagic_status ile build bittiginde test et' talimati, "
        "5) QA PASS → store submission. "
        "SPEC dosyasi repo'da yoksa (shipped app'ler icin olabilir) — @dev'e direkt build tetikle de. "
